class Game{
    ...
    readGameState(){
      ...
      start(){
        ...
        console.log("luna");
        /*if(player1.house.equalsIgnoreCase("Gryffindor")){
          player1.addImage("harry", hp4IMG); 
         }
        else if(player1.house.equalsIgnoreCase("Ravenclaw")){
          player1.addImage("luna",hp1IMG);
        }
        else if(player1.house.equalsIgnoreCase("Slytherin")){
          player1.addImage("draco",hp3IMG);
        }
        else{
          player1.addImage("cedric",hp4IMG);
        }*/
      ...
      console.log("cedric");
      /*if(player2.house.equalsIgnoreCase("Gryffindor")){
        player2.addImage("harry", hp4IMG);
       }
       else if(player2.house.equalsIgnoreCase("Ravenclaw")){
        player2.addImage("luna",hp1IMG);
       }
       else if(player2.house.equalsIgnoreCase("Slytherin")){
        player2.addImage("draco",hp3IMG);
       }
       else{
        player2.addImage("cedric",hp2IMG);
       }*/
      ...
      console.log("draco");
      /*if(player3.house.equalsIgnoreCase("Gryffindor")){
        player3.addImage("harry", hp4IMG);
       }
       else if(player3.house.equalsIgnoreCase("Ravenclaw")){
        player3.addImage("luna",hp1IMG);
       }
       else if(player3.house.equalsIgnoreCase("Slytherin")){
        player3.addImage("draco",hp3IMG);
       }
       else{
        player3.addImage("cedric",hp2IMG);
       }*/
      ...
      console.log("harry");
      /*if(player4.house.equalsIgnoreCase("Gryffindor")){
        player4.addImage("harry", hp4IMG);
       }
       else if(player4.house.equalsIgnoreCase("Ravenclaw")){
        player4.addImage("luna",hp1IMG);
       }
       else if(player4.house.equalsIgnoreCase("Slytherin")){
        player4.addImage("draco",hp3IMG);
       }
       else{
        player4.addImage("cedric",hp2IMG);
       }*/
